...
txt ="Your waifus are all trash @everyone @everyone @everyone."
...
out_pink('Enter your bot TOKEN htpt://discordapp.com/developers/applications/')

out_blue('Alt + Space   -> edit -> paste')
out_yellow('hey, that rhymes')
TOKEN = input('>>>')
...
class MyClient(discord.Client):
    ...
    async def on_ready(self):
        ...
        out_blue('DISCORD servers(guilds) your bot in:')
